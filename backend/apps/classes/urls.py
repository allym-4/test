...
urlpatterns = [
    ...
    path('practice/<int:pk>/attendance/', views.AdminPracticeAttendanceView.as_view(), name='practice-attendance'),
    path('practice/<int:pk>/add-student/', views.AdminPracticeAddStudentView.as_view(), name='practice-add-student'),
    path('practice/<int:pk>/remove-student/', views.AdminPracticeRemoveStudentView.as_view(), name='practice-remove-student'),
    ...
    path('sessions/<int:pk>/toggle-auto-promote/', views.ToggleAutoPromoteWaitlistView.as_view(), name='session-toggle-auto-promote'),
