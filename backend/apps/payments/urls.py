...
urlpatterns = [
    ...
    path('stripe/refund/', stripe_views.StripeRefundView.as_view(), name='stripe-refund'),
    ...
    path('student-memberships/', views.StudentMembershipListView.as_view(), name='student-membership-list'),
    path('student-memberships/<int:pk>/', views.StudentMembershipDetailView.as_view(), name='student-membership-detail'),
    path('student-memberships/bulk-assign/', views.BulkAssignMembershipView.as_view(), name='student-membership-bulk-assign'),
