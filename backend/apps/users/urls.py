...
urlpatterns = [
    ...
    path('announcements/<int:pk>/dismiss/', views.AnnouncementDismissView.as_view(), name='announcement-dismiss'),
    ...
    path('<int:user_pk>/skills/batch-approve/', views.SkillBatchApproveView.as_view(), name='student-skills-batch'),
    path('<int:user_pk>/skill-summary/', views.StudentSkillSummaryView.as_view(), name='student-skill-summary'),
    ...
    path('skill-levels/<int:pk>/skills/', views.SkillLevelAddSkillView.as_view()),
...
leads_urlpatterns = [
    ...
    path('<int:pk>/log-contact/', views.LeadLogContactView.as_view(), name='lead-log-contact'),
]
