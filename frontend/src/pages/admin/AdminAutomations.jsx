...
const AUTOMATION_DEFS = [
  ...
  { slug: 'welfare_checkin', icon: '💚', name: 'Welfare Check-in', desc: 'Sends a personal check-in to students showing concerning attendance patterns.', trigger: 'Attendance < 50% over 4 classes', action: 'Send welfare email from studio admin', category: 'comms', defaultEnabled: false },
