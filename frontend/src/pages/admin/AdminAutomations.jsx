...
const DEFAULT_COPY = {
  ...
  welfare_checkin: { subject: "Checking in with you ♡", body: "Hi {{first_name}},\n\nI wanted to personally check in to see how you're going. We've noticed you haven't been to as many classes recently and just wanted to make sure everything is okay.\n\nPlease don't hesitate to reach out if there's anything we can do to support you.\n\nWith love,\nIntrigued" },
