          ...
          <>
            ...
            {onPaymentPlan && (
              <button
                ...
                style={{ width: '100%', background: 'none', border: '1px solid #444', borderRadius: 14, padding: '16px 0', fontSize: 13, fontWeight: 700, letterSpacing: 0.5, cursor: addingToPlan ? 'default' : 'pointer', color: '#fff', marginBottom: 10 }}
              >
            ...
            {onCash && (
              <button
                ...
                style={{ width: '100%', background: 'none', border: '1px solid #333', borderRadius: 14, padding: '16px 0', fontSize: 13, fontWeight: 700, letterSpacing: 0.5, cursor: 'pointer', color: '#888', marginBottom: 16 }}
              >
                I WANT TO PAY CASH
              </button>
            )}
